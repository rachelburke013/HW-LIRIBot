...
function getMyTweets(){
	...
	var params = {screen_name: 'RachelB33034207', count: 20, exclude_replies:true, trim_user:true};
...
function movieThis(movieName){
	...
	request("http://www.omdbapi.com/?i=tt3896198&apikey=8f73fa3d" + tmdbKey + "&query=" + movieName, function(error, response, body) {
  	...
  	if (!error && response.statusCode === 200) {
	    ...
	    var queryURL = "https://api.themoviedb.org/3/movie/" + movieID + "trilogy" + tmdbKey + "&append_to_response=credits,releases";
